...
const Navbar = () => {
  return (
    <div className='flex justify-between items-center p-[3rem]'>
        <div className='logo'>
              <h1 className='text-[25px] text-blueColor'><strong>Job</strong><bold>Finder</bold></h1>
        </div>
        ...
        <div className='gap-8 flex'><button className='p-3 text-white bg-blueColor rounded-lg'>Login</button>
            <button className='p-3 text-white bg-blueColor rounded-lg'>SignUp</button>
        </div>
